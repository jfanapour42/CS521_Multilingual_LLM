...
class WikiBibDataset(torch.utils.data.Dataset):
    def __init__(self,
        ...
        print(
            'Dataset created, with settings: source: {}\n target: {} \n max len: {} \n source_lang: {}\n target_lang: {}'.format(
                self.source_directory, self.target_directory, self.max_len, self.source_lang, self.target_lang))
    ...
    def create_upsampled_dataset(self):
        ...
        print('Starting with {} source examples and {} target examples'.format(num_source_examples,
                                                                               len(self.target_examples)))
